  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Welcome Section */}
        {user && (
          <div className="mb-8 p-6 bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-xl border border-slate-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-200 mt-1">{user.department} • Security Operations Dashboard</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="border-slate-700 bg-gradient-to-br from-slate-800/50 to-slate-700/30 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-white mb-1">{realTimeStats.vulnerabilities}</div>
              <p className="text-xs text-yellow-400">-2 patched today</p>
          ...
          <Card className="border-slate-700 bg-gradient-to-br from-slate-800/50 to-slate-700/30 backdrop-blur-sm">
            ...
            <CardContent>
              ...
              <Progress value={realTimeStats.systemUptime} className="h-2 mt-2" />
            </CardContent>
          </Card>
        </div>
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Badge 
                        ...
                        className={module.status === 'active' ? 'bg-green-500/20 text-green-400' : ''}
                      >
                        {module.status}
                      </Badge>
                    </div>
