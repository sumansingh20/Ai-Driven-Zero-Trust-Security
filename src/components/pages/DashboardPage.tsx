/**
 * Dashboard Page Component - Security Operations Center
...
import type { UserInfo, SecurityModule, RealTimeStats } from "@/src/types";
import { STORAGE_KEYS, DASHBOARD_CONFIG } from "@/src/config/constants";
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-slate-400">
                    Last login: <ClientTime format="datetime" />
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
          ...
          <div className="flex flex-col items-end space-y-2">
            <div className="flex items-center space-x-4">
              <Badge variant="outline" className="text-sm px-3 py-1 text-yellow-500 border-yellow-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
          ...
          <Card className="border-slate-700 bg-gradient-to-br from-slate-800/50 to-slate-700/30 backdrop-blur-sm">
            ...
            <CardContent className="px-3 pb-3">
              ...
              <p className="text-xs text-blue-400 mb-1">AI Accuracy: {realTimeStats.aiAccuracy}%</p>
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        ...
                        className={
                          module.status === "active" ? "bg-green-500/20 text-green-400 text-xs" : "text-xs"
                        }
                      >
                        {module.status}
                      </Badge>
        ...
        <div className="space-y-3">
          ...
          <Alert className="border-red-500 bg-red-500/10">
            ...
            <AlertDescription className="text-red-400">
              <strong>Critical Alert:</strong> Potential advanced persistent threat detected in network segment
              192.168.1.0/24
